...
public class AuthorSearchBar extends HBox {

    private static final Logger LOGGER = LoggerFactory.getLogger(AuthorSearchBar.class);
    ...
    public AuthorSearchBar(JabRefFrame frame, StateManager stateManager, PreferencesService preferencesService, CountingUndoManager undoManager) {
        super();
